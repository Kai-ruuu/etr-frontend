            ...
            <CardContent>
              <form onSubmit={handleNotificationSubmit} className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="companyVerificationAlerts">Company Verification Alerts</Label>
                      <p className="text-sm text-muted-foreground">
                        Get notified when new companies need verification
                      </p>
                    </div>
                    <Switch
                      id="companyVerificationAlerts"
                      checked={notifications.companyVerificationAlerts}
                      onCheckedChange={(value) => handleNotificationChange('companyVerificationAlerts', value)}
                    />
                  </div>
...
export default PesoAccountPage